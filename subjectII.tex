...
As superf\a'icies qu\'adricas s\~ao solu\c{c}\~oes de equa\c{c}\~oes da forma
\[ ax^2 + by^2 + cz^2 \> + \> dxy + eyz + fxz \> + \> gx + hy + iz \> + \> j = 0 \]


\section{Fun\c{c}\~oes de duas ou mais vari\'aveis}
Uma fun\c{c}\~ao de 2 vari\'aveis \'e uma fun\c{c}\~ao do tipo
\[ f: D \rightarrow \mathbb{R} \qquad \text{onde} \> D \subseteq \mathbb{R}^2 \]

\subsection{Gr\'aficos}
O gr\'afico de uma fun\c{c}\~ao $f: D \rightarrow \mathbb{R}$ de duas vari\'aveis \'e o subconjunto de $\mathbb{R}^3$ formado pelos pontos
\[ (x,\, y,\, f(x, y)) \in \mathbb{R}^3 \qquad \text{onde} \> (x,\, y) \in D \]



\subsection{Curvas e Superf\a'icies de N\a'ivel}
Uma curva de n\a'ivel de altura $h$ de uma fun\c{c}\~ao $f: D \rightarrow \mathbb{R}$ \'e o conjunto de pontos $(x, y)$ do plano tais que
\[ f(x,y) = h \]
